...
Page({
    ...
    onShareAppMessage: function(t) {
        ...
        if (console.log(s, i, c), "" == i) var u = o.data.user_name + "邀您一起拆" + a + "的" + o.data.system.hb_name; else u = (u = o.data.system.hb_content.replace("name", o.data.user_name)).replace("type", "【" + o.data.post.type_name + "】");
