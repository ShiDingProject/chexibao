...
Page({
    ...
    formSubmit: function(e) {
        ...
        var o = this.data.countries[e.detail.value.splx], n = e.detail.value.px, c = e.detail.value.spmc, u = e.detail.value.sj, d = e.detail.value.yj, g = e.detail.value.spsl, r = e.detail.value.starttime, p = e.detail.value.endtime, m = e.detail.value.jztime, h = e.detail.value.spjj, f = e.detail.value.spxq;
        console.log(t, l, o, n, c, u, d, g, h, f, r, p, m, i, a, s);
        var v = "", x = !0;
