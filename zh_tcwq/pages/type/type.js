...
Page((_defineProperty(_Page = {
    ...
    jumps: function(t) {
        var e = this, a = (t.currentTarget.dataset.name, t.currentTarget.dataset.appid), n = t.currentTarget.dataset.src, r = t.currentTarget.dataset.id, i = t.currentTarget.dataset.sjtype;
        console.log(r);
    ...
    refresh: function(t) {
        var i = this, e = wx.getStorageSync("city");
        app.util.request({
            ...
            success: function(t) {
                console.log(t);
                var e = [], a = [], n = [];
                for (var r in t.data) 8 == t.data[r].type && e.push(t.data[r]), 5 == t.data[r].type && a.push(t.data[r]), 
                7 == t.data[r].type && n.push(t.data[r]);
                i.setData({
                    slide: e,
                    advert: a,
                    ggslide: n
            ...
            success: function(t) {
                var e = t.data;
                e.length <= 5 ? i.setData({
                    height: 165
                }) : 5 < e.length && i.setData({
                    height: 330
                });
                for (var a = [], n = 0, r = e.length; n < r; n += 10) a.push(e.slice(n, n + 10));
                console.log(a, e), i.setData({
                    nav: a,
                    navs: e
                });
            }
    ...
    var o = this, e = o.data.index_class, a = wx.getStorageSync("city"), n = wx.getStorageSync("index"), s = o.data.page, c = o.data.seller;
    if (console.log(a), 1 == e) {
    ...
    function a(t, e) {
        for (var a = "" + t, n = a.length, r = "", i = e; i-- > n; ) r += "0";
        return r + a;
    }
}), _defineProperty(_Page, "thumbs_up", function(t) {
    var a = this, n = a.data.seller, r = t.currentTarget.dataset.id, i = wx.getStorageSync("users").id, e = (Number(t.currentTarget.dataset.num), 
    function(e) {
        n[e].tz.id == r && (n[e].thumbs_up = !0, app.util.request({
    ...
    console.log(t);
    var e = t.currentTarget.dataset.id, a = this.data.url, n = [], r = t.currentTarget.dataset.inde, i = this.data.seller;
    for (var o in i) if (i[o].tz.id == e) {
        var s = i[o].tz.img;
