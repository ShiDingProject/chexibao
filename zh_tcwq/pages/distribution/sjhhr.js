...
Page({
    ...
    formSubmit: function(t) {
        ...
        var e = this, a = wx.getStorageSync("city"), o = this.data.wdsq.level, n = wx.getStorageSync("users").id, c = wx.getStorageSync("openid"), s = t.detail.formId, i = e.data.accountIndex, l = e.data.dqdjindex;
        app.util.request({
        ...
        var r = Number(e.data.accounts[i].money), u = Number(e.data.accounts[l].money), d = e.data.accounts[i].id, g = parseFloat((r - u).toFixed(2));
        console.log(n, c, s, i, l, r, u, g, d, a, o);
        var p = "", f = !0;
        Number(i) <= l ? p = "请选择高于你当前的等级进行升级！" : g < 0 ? p = "升级错误，请联系平台管理员设置正确等级金额！" : (f = !1, 
        wx.showModal({
            title: "提示",
