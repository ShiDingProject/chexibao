...
Page({
    ...
    tabClick: function(t) {
        ...
        "0" == t.currentTarget.id && (a.state = "", a.orderby = "a.time desc"), "1" == t.currentTarget.id && (a.state = "1", a.orderby = "a.hx_time desc"), console.log(a, t.currentTarget.dataset.index), this.setData({
    ...
    lqlb: function() {
        var e = this,
            o = e.data.pagenum;
        e.data.params.page = o, e.data.params.pagesize = 10, console.log(o, e.data.params), app.util.request({
