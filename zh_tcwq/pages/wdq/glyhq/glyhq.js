...
Page({
    ...
    cksj: function(t) {
        var e = t.currentTarget.dataset.yhqid,
            a = t.currentTarget.dataset.sjid;
    ...
    reLoad: function() {
        var n = this,
            t = this.data.store_id,
            c = util.formatTime(new Date).substring(0, 10).replace(/\//g, "-");
        console.log(t, c), app.util.request({
            ...
            success: function(t) {
                console.log(t.data);
                for (var e = t.data, a = [], o = [], s = 0; s < e.length; s++) "3" != e[s].state && util.validTime1(c, e[s].end_time) ? a.push(e[s]) : (e[s].isTouchMove = !1, o.push(e[s]));
    ...
    del: function(t) {
        var e = this,
            a = t.currentTarget.dataset.yhqid;
