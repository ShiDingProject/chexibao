...
Page({
    ...
    refresh1: function(t) {
        var s = this, a = wx.getStorageSync("city");
        console.log(s.data.type2_id), console.log(s.data.type2_name), app.util.request({
            url: "entry/wxapp/PostList",
            cachetime: "0",
            data: {
                type2_id: s.data.type2_id,
                page: s.data.page1,
                cityname: a
            },
            success: function(t) {
                console.log(t), 0 == t.data ? (wx.showToast({
                    ...
                    page1: s.data.page1 + 1
                });
                var a, e = s.data.tie1;
                for (var i in console.log(e), e = e.concat(t.data), t.data) {
                    t.data[i].tz.type2_name = s.data.type2_name;
                    var n = s.ormatDate(t.data[i].tz.time);
